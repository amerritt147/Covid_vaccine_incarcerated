...
file = open('/Users/alexesmerritt/Desktop/UCLA DATA/prison_populations.csv') ##data from PPP
...
df_new.to_csv('/Users/alexesmerritt/Desktop/Prison Vaccinaiton Project/state_pops.csv')
